...
<body>
    ...
    <section id="res">
        <div class="row no-gutters">
            ...
            <div class="col-md-5 offset-md-0 col-11 offset-1 mt-2 text-right hidden" id="realEstate">
                <h3 style="margin-right: 20px">For buying real estate, <a href="mailto:abdulrahman.almonajed@gmail.com" style="text-decoration: none;"><span class="text-primary">contact us</span></a></h3>
            </div>
            <!--<div class="col-2">
        ...
        if ($count > 0) {
            ...
            <ul class="list-group list-group-flush mr-5 mt-3" style=" border:none;float:right; margin-top:-100px; ">
                ...
                <a href="#"  data-toggle="modal" data-target="#dateSelection' . $row["ID"] . '"> 
                    <button class="btn btn-primary " value="Select " style="width:125px;color:white " />Select</button>
                </a>
                </li>

                <li class="list-group-item " style="border:none">
                <a href="#" data-toggle="collapse" data-target="#apartmentFeedbackCollapse' . $row["ID"] . '">
                    <button class="btn btn-primary " style="width:150px;color:white "  id="apartmentFeedback' . $row["ID"] . '" />Leave Feedback</button> 
                </a>
                </li>
            </ul>
            ...
            <div class="collapse feedCollapse mr-4 ml-4" id="apartmentFeedbackCollapse' . $row["ID"] . '">
                ...
                <input type="button" onclick="feedClick(id)" class="btn btn-success mt-3 mb-3" value="Send" id="apartmentFeedbackSend' . $row["ID"] . '" >         
            </div>
    ...
    <script>
        ...
        $(window).on("load", function() {
            $(document).ready(function() {
                ...
                var allFeedbackBtn = $('input[id ^= "apartmentFeedbackSend"')
    ...
    <script>
        function feed(id) {
            ...
            console.log($('#apartmentFeedbackSend' + idRes).val())
            var but = $('#apartmentFeedbackSend' + idRes).attr("id");
            var idBut = id.replace(/\D/g, "")
            console.log(idBut)

            $('#apartmentFeedbackSend' + idRes).attr('disabled', true)

            if (feedback != "") {
                $('#apartmentFeedbackSend' + idRes).attr('disabled', false)
            }
        }
        ...
        function feedClick(id) {
            ...
            $.ajax({
                url: "dbSend/apartmentFeedback.php?task=sendFeed&idRes=" + idBut + "&feedback=" +
