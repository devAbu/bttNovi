...
<body>
    ...
    <section>
        ...
        if ($count > 0) {
            ...
            <ul class="list-group list-group-flush mr-5 mt-3" style=" border:none;float:right; margin-top:-100px; ">
                ...
                <li class="list-group-item " style="border:none">
                <a href="#" data-toggle="collapse" data-target="#hotelFeedbackCollapse' . $row["ID"] . '" > 
                    <button class="btn btn-primary " style="width:150px; "  id="hotelFeedback' . $row["ID"] . '" />Leave Feedback</button>
                </a>
                </li>
            </ul>
            ...
            <div class="collapse feedCollapse mr-4 ml-4" id="hotelFeedbackCollapse' . $row["ID"] . '">
                ...
                <input type="button" onclick="feedClick(id)" class="btn btn-success mt-3 mb-3" value="Send" id="hotelFeedbackSend' . $row["ID"] . '" >         
            </div>
            <div class="card-footer text-muted ">
    ...
    <script>
        ...
        function feedClick(id) {
            ...
            $.ajax({
                url: "dbSend/hotelFeedback.php?task=sendFeed&idRes=" + idBut + "&feedback=" +
